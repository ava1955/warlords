...
// class ChargeSkippedException : public std::exception {
// public:
//     const char* what() const noexcept override {
//         return "Charge skipped.";
//     }
// };
//
// class InvalidProvinceException : public std::exception {
// public:
//     const char* what() const noexcept override {
...
//
// int main() {
//     std::vector<std::string> aux = {"Province1", "Province2", "Province3"}; // Example provinces
//     char Q;
//     int x;
//     bool ok = false;
//
...
//         if (Q == 'Q' || Q == 'q') {
//             ok = true;
//             throw ChargeSkippedException();  // Charge skipped scenario
//         }
//
//         // Handle x input
//         std::cin >> x;
//         if (x == -1) {
//             throw std::runtime_error("Skipping left logic.");  // Custom logic to handle -1 case
//         }
//         if (x == 0) {
//             std::cout << "\nGame aborted." << std::endl;
//             return 0;  // Aborting the game
//         }
//
...
//             }
//
//             if (validProvince) break;  // Valid province entered
//
//             // If invalid, throw exception
//             throw InvalidProvinceException();
//         }
//
//     } catch (const ChargeSkippedException& e) {
//         std::cout << e.what() << std::endl;
//         goto charged;  // Move to a label or continue with your logic, e.g., marking the charge as skipped
//
//     } catch (const InvalidProvinceException& e) {
//         std::cout << e.what() << std::endl;
//         // No goto needed, just continue to ask for a valid province
//
...
//
// charged:
//     std::cout << "Charge process completed or skipped." << std::endl;
//
//     return 0;
// }
